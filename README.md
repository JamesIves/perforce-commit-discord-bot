...
3. The service requires access to the `p4 changes` command in the terminal, your bot should be installed somewhere where it can automatically perform this command without requiring su permissions. Once suitable access has been provided you can initialize the service by running `$ python app.py`.
